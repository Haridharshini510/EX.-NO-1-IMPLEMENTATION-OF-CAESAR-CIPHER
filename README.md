...
STEP-3: If the key is positive then encrypt the text by adding the key
with each character in the plain text.
...
## RESULT :
Thus the implementation of ceasar cipher had been executed
successfully.
